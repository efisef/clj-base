...
RUN jlink -c --no-man-pages --no-header-files -G --module-path $JAVA_HOME/jmods --add-modules java.base,java.net.http,java.management,java.rmi,java.sql,java.naming,jdk.unsupported,jdk.crypto.cryptoki --output /usr/bin/jre
